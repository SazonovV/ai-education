...
5. [Итоги и практика](#5-итоги-и-практика)
...
5. **Безопасность — приоритет.** MCP-сервер — расширение агента. Проверяйте серверы, ограничивайте разрешения.
